# 💫 About Me:
Brian Felts<br><br>Software Engineering graduate with experience building full-stack web applications, cross-platform mobile apps, and desktop applications using C# and .NET.<br><br>Tech<br>- C#, .NET (ASP.NET Core Razor Pages, .NET MAUI, WinForms)<br>- PostgreSQL, MySQL<br>- JavaScript, Python<br>- REST APIs<br><br>Projects<br>- Full-stack HOA ticketing platform (ASP.NET Core, Identity, role-based access)<br>- WGU term & course tracking mobile app (.NET MAUI)<br>- Desktop applications with database integration<br><br>GitHub is used to showcase coursework, capstone projects, and personal development work.<br>
